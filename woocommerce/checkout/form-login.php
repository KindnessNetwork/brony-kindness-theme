...
woocommerce_login_form(
    ...
    ' <p><b>' . __('NOTE: This account is NOT linked to the registration system. You will need to create a new account. You cannot login to your reg account from here.') . '</b></p>',
